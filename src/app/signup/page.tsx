...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Main content container with image on left and form on right */}
      <main className="flex min-h-[calc(100vh-4rem)] items-center justify-center p-2 sm:p-4 lg:p-6">
        <div className="flex w-full max-w-5xl overflow-hidden rounded-lg shadow-lg bg-white">

          {/* Left side: Image (50% width on md and up) */}
          <div className="hidden md:block md:w-1/2">
            <img
              src="/Copilot_20250606_194011.png"
              alt="Signup page illustration"
              className="h-full w-full object-cover"
            />
          </div>

          {/* Right side: Signup Form (50% width on md and up) */}
