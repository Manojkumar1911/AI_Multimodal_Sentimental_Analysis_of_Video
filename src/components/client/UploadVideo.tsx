...
function UploadVideo({ apiKey, onAnalysis, onStatusChange }: UploadVideoProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      {/* Upload video container with stunning light gradient from left to right and centered content */}
      <div className="flex w-full cursor-pointer flex-col items-center justify-center gap-4 rounded-2xl border border-dashed border-gray-300 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 p-12 shadow-lg transition-all duration-500 hover:shadow-xl hover:ring-blue-200 text-slate-800">
        <input
          type="file"
